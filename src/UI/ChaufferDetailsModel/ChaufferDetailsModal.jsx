...
import "./chaufferDetailsModel.scss"
  ...
  return (
    <section>
      <div className="account-section mt-[20px]">
        <div className="text-[#0D0D0D] text-[24px] mb-[10px] flex justify-center mt-[100px] font-medium"></div>
                            ...
                            <div className="vehicleDetails">
                              ...
                              <div className="vehicle_detail">
                                ...
                                <p style={{marginBottom:"5px"}}>
                                  {" "}
                                  <b>MTN Number: </b> 7894-MTN-5678
                                </p>
                                <Flex justify="space-between" align="center">
                                  <Flex align="center" gap={"8px"} >
                                    <PiSeatbeltLight style={{fontSize:"20px"}}/>
                                    <span style={{fontSize:"14px", fontWeight:"600"}}> 4</span>
                                  </Flex>
                                  <Flex align="center" gap={"8px"}>
                                    <GiRollingSuitcase style={{fontSize:"20px"}}/>
                                    <span style={{fontSize:"14px", fontWeight:"600"}}> 3</span>
                                  </Flex>
                                </Flex>
                              </div>
                              <FormsButton style={{fontSize:"12px"}}  title="Vehicle & Insurance Document" />
                            </div>
...
export default ChaufferDetailsModal
