...
import ForgetPwd from "../pages/Authentication/ForgetPasswords"
...
import PatientScreen from "../pages/Patient/index"
import DoctorScreen from "../pages/Doctor/index"
import PharmaciesScreen from "../pages/Pharmacies/index"
import BookingScreen from "../pages/Booking/index"
import PaymentScreen from "../pages/PaymentHistory/index"
...
import ChauffeursScreen from "../pages/Pharmacies/index"
import DynamicDetailsPage from "components/DynamicDetailsPage/DynamicDetailsPage"
import AffiliateScreen from "../pages/Reception/index"

const userRoutes = [
  { path: "/dashboard", component: Dashboard },
  // //patient
  { path: "/admin/customers", component: PatientScreen },
  // //doctor
  { path: "/admin/cars", component: DoctorScreen },
  // //pharmacies
  { path: "/admin/chauffeur", component: ChauffeursScreen },
  { path: "/admin/affiliate", component: AffiliateScreen },
  // //booking
  { path: "/admin/rides-booking", component: BookingScreen },
  { path: "/admin/rides-booking-details", component: DynamicDetailsPage },

  // //payment
  { path: "/admin/payment", component: PaymentScreen },
  // //Reception
  { path: "/admin/reception", component: ReceptionScreen },
  // //CMS
  { path: "/admin/cms", component: CmsScreen },
  // //Medical Condition
  { path: "/admin/chauffer-details", component: MedicalConditionScreen },
