...
const ChauffeursScreen = () => {
  ...
  const ActionIcons = (chauffeur) => (
    <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
      <Link to={{pathname:`/admin/chauffeur-details/${chauffeur?._id}`,state:{chauffeur}}}>
        <FaRegEye />
      </Link>
      <FaCheck
        title="Approve"
    ...
    <>
      ...
      <div className="page-content">
        <div className="container-fluid">
          <h2 className="page-title-dash">Chauffeurs</h2>
...
export default ChauffeursScreen;
